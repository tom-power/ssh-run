...
func Test_runFs(t *testing.T) {
	t.Run("can list hosts", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("", "", sshrun.RunFlags{Hosts: true}, []string{})
	...
	t.Run("can explain host", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "", sshrun.RunFlags{Explain: true}, []string{})
	...
	t.Run("can ssh", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "ssh", sshrun.RunFlags{}, []string{})
	...
	t.Run("can list scripts", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "", sshrun.RunFlags{Scripts: true}, []string{})
	...
	t.Run("can run script", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "remote", sshrun.RunFlags{}, []string{})
	...
	t.Run("can explain script", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "remote", sshrun.RunFlags{Explain: true}, []string{})
		expected := "ssh -p 22 user@192.0.2.1 \"command\""
		if actual != expected {
			t.Errorf("'%v' should equal '%v'", actual, expected)
		}
	...
	t.Run("can run script with args", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "withArgs", sshrun.RunFlags{}, []string{"arg1", "arg2"})
	...
	t.Run("can run script with pty", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "pty", sshrun.RunFlags{}, []string{})
	...
	t.Run("can run script x11", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "x11", sshrun.RunFlags{}, []string{})
	...
	t.Run("can run script local", func(t *testing.T) {
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("test", "local", sshrun.RunFlags{}, []string{})
		if actual != "command" {
	...
	t.Run("can get help on empty", func(t *testing.T) {
		...
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("", "", sshrun.RunFlags{}, []string{})
	...
	t.Run("can get help with option", func(t *testing.T) {
		expectedContains := "Usage"
		actual, _ := sshrun.Runner{Config: testConfig, Fsys: testFs}.Run("", "", sshrun.RunFlags{Help: true}, []string{})
		if !strings.Contains(actual, expectedContains) {
			t.Errorf("'%v' should start with '%v'", actual, expectedContains)
		}
	})
